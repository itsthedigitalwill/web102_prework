...
function addGamesToPage(games) {
    ...
    for(let i = 0; i < games.length; i++){
        let grabList = document.createElement('div');

        grabList.classList.add('game-card');
        ...
        `;
        //adding thr backers line to match with the challenge

        gamesContainer.appendChild(grabList);
...
infoP.innerHTML = displayStr;
descriptionContainer.appendChild(infoP);
